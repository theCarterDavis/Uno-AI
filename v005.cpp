...
v005::v005(int playerNumber) : AI(playerNumber)
{
...
void v005::onOtherPlayerMove(int playerNumber, Card justPlayed, Color choosenCardColor)
{

}

void v005::onOtherPlayerDraw(int playerNumber)
{
...
void v005::merge(vector<Card> & a, vector<Card> & tmpArray,int leftPos, int rightPos, int rightEnd)
{
...
void v005::mergeSort( vector<Card> & a,vector<Card> & tmpArray, int left, int right )
{
    if( left < right )
    {
 ...
 */
void v005::mergeSort( vector<Card> & a )
{
...
int v005::makeMove(Card justPlayed, Color choosenCardColor, bool justDrew, vector<int> scores, vector<int> cardAmountsByPlayer, vector<Card> cardsInHand,int direction) {
...
string v005::getName()
{
    return "In a Really Really Really Really Bad Mood :(";
}



Color v005::getNewColor()
{
    return savedColor;
}