...
v004::v004(int playerNumber) : AI(playerNumber)
{
...
void v004::onOtherPlayerMove(int playerNumber, Card justPlayed, Color choosenCardColor)
{

}

void v004::onOtherPlayerDraw(int playerNumber)
{
...
void v004::merge(vector<Card> & a, vector<Card> & tmpArray,int leftPos, int rightPos, int rightEnd)
{
...
void v004::mergeSort( vector<Card> & a,vector<Card> & tmpArray, int left, int right )
{
    if( left < right )
    {
 ...
 */
void v004::mergeSort( vector<Card> & a )
{
...
int v004::makeMove(Card justPlayed, Color choosenCardColor, bool justDrew, vector<int> scores, vector<int> cardAmountsByPlayer, vector<Card> cardsInHand,int direction) {
...
string v004::getName()
{
    return "In a Really Really Really Bad Mood :(";
}



Color v004::getNewColor()
{
    return savedColor;
}