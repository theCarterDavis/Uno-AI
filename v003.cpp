...
v003::v003(int playerNumber) : AI(playerNumber)
{
...
void v003::onOtherPlayerMove(int playerNumber, Card justPlayed, Color choosenCardColor)
{

}

void v003::onOtherPlayerDraw(int playerNumber)
{
...
void v003::merge(vector<Card> & a, vector<Card> & tmpArray,int leftPos, int rightPos, int rightEnd)
{
...
void v003::mergeSort( vector<Card> & a,vector<Card> & tmpArray, int left, int right )
{
    if( left < right )
    {
 ...
 */
void v003::mergeSort( vector<Card> & a )
{
...
int v003::makeMove(Card justPlayed, Color choosenCardColor, bool justDrew, vector<int> scores, vector<int> cardAmountsByPlayer, vector<Card> cardsInHand,int direction) {
...
string v003::getName()
{
    return "In a Really Really Bad Mood :(";
}



Color v003::getNewColor()
{
    return savedColor;
}
