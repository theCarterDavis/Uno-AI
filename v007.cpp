...
v007::v007(int playerNumber) : AI(playerNumber)
{
    bluePlayed = 0;
    redPlayed = 0;
    greenPlayed = 0;
...
void v007::onOtherPlayerMove(int playerNumber, Card justPlayed, Color choosenCardColor)
{
...
void v007::onOtherPlayerDraw(int playerNumber)
{
...
void v007::merge(vector<Card> & a, vector<Card> & tmpArray,int leftPos, int rightPos, int rightEnd)
{
...
void v007::mergeSort( vector<Card> & a,vector<Card> & tmpArray, int left, int right )
{
    if( left < right )
    {
 ...
 */
void v007::mergeSort( vector<Card> & a )
{
...
int v007::makeMove(Card justPlayed, Color choosenCardColor, bool justDrew, vector<int> scores, vector<int> cardAmountsByPlayer, vector<Card> cardsInHand,int direction) {


    int redH = 0, greenH = 0, blueH = 0, yellowH = 0, blackH = 0;
    bool hasRed = false, hasBlue = false, hasGreen = false, hasYellow = false;
    ...
    if(yellowPlayed > greenPlayed && yellowPlayed > bluePlayed && yellowPlayed > redPlayed && hasYellow){
        savedColor = YELLOW;
    } else if(greenPlayed > yellowPlayed && greenPlayed > bluePlayed && greenPlayed > redPlayed && hasGreen ){
        savedColor = GREEN;
    } else if(bluePlayed > yellowPlayed && bluePlayed > greenPlayed && bluePlayed > redPlayed && hasRed) {
        savedColor = BLUE;
    }
...
string v007::getName()
{
    return "In a Really Really Really Really Really Really Bad Mood :(";
}



Color v007::getNewColor() {
    return savedColor;
}